    ...
    return (
        ...
        <div className="flex flex-col gap-3 lg:gap-8">
            <div className="flex items-center gap-3 md:px-4">
                ...
                <span className="bg-gray-800 p-1 text-xs text-white rounded-md">
                    Streaming Now
                    </span>
            </div>
              ...
              <div className="flex flex-col-reverse gap-3 lg:gap-5 lg:flex-col">
                ...
                <h4>{(movie.runtime / 60).toFixed(2)}h &bull; {genres} &bull; 13+</h4>
                    ...
                    <div className="flex items-center gap-3 md:px-4 md:w-screen lg:w-full">
                       <button onClick={rentMovies} className="bg-red-500 w-full py-3 text-white font-semibold rounded-md">
                             Rent ₹149
                        </button>
                        <button onClick={buyMovies} className="bg-red-500 w-full py-3 text-white font-semibold rounded-md">
                             Buy ₹499
                        </button>
                   </div>
               </div>
